...
export class CarService {
  ...
  getCarsByColorAndBrand(colorId:number,brandId:number):Observable<ListResponseModel<CarDetailsDto>>{
    return this.httpClient.get<ListResponseModel<CarDetailsDto>>(this.apiUrl+"/cars/getcarsdetailbycoloridandbrandid?colorId="+colorId+"&brandId="+brandId);
  }
